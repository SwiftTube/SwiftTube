...
To fix a bug, add a feature or any change we recommend to use our [labels](https://github.com/SwiftTube/SwiftTube/labels) and [formatting](https://github.com/SwiftTube/SwiftTube/blob/main/.github/ISSUE_TEMPLATE/issue_template.md) before making your request, this will help us better handle pull requests and issues.
